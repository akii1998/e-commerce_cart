...
const Footer = () => {
  ...
  <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <p className="col-md-4 mb-0 text-muted">© 2023 AK CART , Jaipur(Raj)</p>
    ...
    <ul className="nav col-md-4 justify-content-end">
      ...
      <li className="nav-item"><NavLink href="/contact" className="nav-link px-2 text-muted">Contact</NavLink></li>
    </ul>
  </footer>
</div>
    </>
